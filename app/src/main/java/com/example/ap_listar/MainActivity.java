    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGuardarRol.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(nombre.isEmpty()){
                    Toast.makeText(MainActivity.this ,"El nombre es obligatorio", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if(exito){
                    Toast.makeText(MainActivity.this, "Rol guardado", Toast.LENGTH_SHORT).show();
